                    ...
                    <table class="table table-sm table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            while($row = $tasks_qry->fetchArray()):
                                $date_created = new DateTime($row['date_created'], new DateTimeZone('UTC'));$date_created->setTimezone(new DateTimeZone('America/Sao_Paulo'));
                            ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <?php if($_SESSION['type'] == 1): ?>
                                        <a class="btn btn-sm btn-outline-primary rounded-0 edit_data" href="./?page=manage_task&id=<?= $row['task_id'] ?>" data-id='<?= $row['task_id'] ?>' title="Editar Tarefa"><span class="material-symbols-outlined">edit</span></a>
                                        <button class="btn btn-sm btn-outline-danger rounded-0 delete_data" type="button" data-id='<?= $row['task_id'] ?>' title="Deletar Tarefa"><span class="material-symbols-outlined">delete</span></button>
                                        <?php endif; ?>
                                    </div>
                                </td>
                            </tr>
