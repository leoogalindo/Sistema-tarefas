...
<head>
    ...
    <title>LOGIN | Sistemas de Tarefas</title>
...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Sistemas de Tarefas</h3>
            ...
            <div class="card-body">
                ...
                <form action="" id="login-form">
                    ...
                    <div class="mb-3 d-flex w-100 justify-content-between  align-items-end">
                        <a href="registration.php">Não tem uma conta? Se inscreva aqui</a>
